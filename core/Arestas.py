# FIXME: guardar em memória é mais eficiente do que operações de leitura e escrita em arquivo, principalmente quando escalonar e mexer em datasets maiores.
